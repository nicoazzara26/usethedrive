 ...
 * @property {appengine(v1).UrlDispatchRule[]} dispatchRules HTTP path dispatch rules for requests to the application that do not explicitly target a service or version. Rules are order-dependent. @OutputOnly
 ...
 * @property {appengine(v1).ContainerInfo} container A Docker image that App Engine uses to run the version. Only applicable for instances in App Engine flexible environment.
 ...
 * @memberOf! appengine(v1)
 * @type object
 * @property {string} sourceUrl URL of the zip file to deploy from. Must be a URL to a resource in Google Cloud Storage in the form &#39;http(s)://storage.googleapis.com/\/\&#39;.
