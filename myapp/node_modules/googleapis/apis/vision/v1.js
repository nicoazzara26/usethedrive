...
=======
* @property {string} gcsImageUri Google Cloud Storage image URI. It must be in the following form:
...
=======
* @property {vision(v1).EntityAnnotation[]} labelAnnotations If present, label detection completed successfully.
* @property {vision(v1).EntityAnnotation[]} landmarkAnnotations If present, landmark detection completed successfully.
* @property {vision(v1).SafeSearchAnnotation} safeSearchAnnotation If present, safe-search annotation completed successfully.
* @property {vision(v1).ImageProperties} imagePropertiesAnnotation If present, image properties were extracted successfully.
* @property {vision(v1).EntityAnnotation[]} textAnnotations If present, text (OCR) detection completed successfully.
* @property {vision(v1).EntityAnnotation[]} logoAnnotations If present, logo detection completed successfully.
* @property {vision(v1).FaceAnnotation[]} faceAnnotations If present, face detection completed successfully.
* @property {vision(v1).Status} error If set, represents the error message for the operation.
...
=======
* @property {number} tiltAngle Pitch angle. Indicates the upwards/downwards angle that the face is
pointing
relative to the image&#39;s horizontal plane. Range [-180,180].
* @property {string} underExposedLikelihood Under-exposed likelihood.
* @property {vision(v1).BoundingPoly} fdBoundingPoly This bounding polygon is tighter than the previous
...
=======
* @property {number} panAngle Yaw angle. Indicates the leftward/rightward angle that the face is
pointing, relative to the vertical plane perpendicular to the image. Range
[-180,180].
* @property {vision(v1).BoundingPoly} boundingPoly The bounding polygon around the face. The coordinates of the bounding box
are in the original image&#39;s scale, as returned in ImageParams.
...
* @property {vision(v1).Landmark[]} landmarks Detected face landmarks.
* @property {string} blurredLikelihood Blurred likelihood.
* @property {number} rollAngle Roll angle. Indicates the amount of clockwise/anti-clockwise rotation of
the
...
=======
* @property {number} pixelFraction Stores the fraction of pixels the color occupies in the image.
>>>>>>> c23ca8eff604f3eed594314ae0d118e03d71bc8e
Value in range [0, 1].
...
=======
* @property {string} mid Opaque entity ID. Some IDs might be available in Knowledge Graph(KG).
For more details on KG please see:
https://developers.google.com/knowledge-graph/
* @property {string} description Entity textual description, expressed in its &lt;code&gt;locale&lt;/code&gt; language.
* @property {number} topicality The relevancy of the ICA (Image Content Annotation) label to the
...
* @property {vision(v1).Property[]} properties Some entities can have additional optional &lt;code&gt;Property&lt;/code&gt; fields.
For example a different kind of score or string that qualifies the entity.
* @property {number} score Overall score of the result. Range [0, 1].
* @property {vision(v1).BoundingPoly} boundingPoly Image region to which this entity belongs. Not filled currently
>>>>>>> c23ca8eff604f3eed594314ae0d118e03d71bc8e
...
=======
* @property {string} medical Likelihood this is a medical image.
* @property {string} spoof Spoof likelihood. The likelihood that an obvious modification
was made to the image&#39;s canonical version to make it appear
funny or offensive.
* @property {string} violence Violence likelihood.
* @property {string} adult Represents the adult contents likelihood for the image.
>>>>>>> c23ca8eff604f3eed594314ae0d118e03d71bc8e
*/
/**
 * @typedef Image
