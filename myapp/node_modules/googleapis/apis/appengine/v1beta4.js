        ...
        instances: {
          ...
          delete: function (params, options, callback) {
            ...
            var parameters = {
              ...
              pathParams: ['appsId', 'modulesId', 'versionsId', 'instancesId'],
              context: self
            };
...
=======
 * @property {appengine(v1beta4).Status} error The error result of the operation in case of failure.
>>>>>>> c23ca8eff604f3eed594314ae0d118e03d71bc8e
 ...
 * @property {appengine(v1beta4).ContainerInfo} container A Docker image that App Engine uses the run the version. Only applicable for instances in App Engine flexible environment.
