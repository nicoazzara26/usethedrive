...
* @property {logging(v2beta1).HttpRequest} httpRequest Optional. Information about the HTTP request associated with this
log entry, if applicable.
<<<<<<< HEAD
* @property {logging(v2beta1).LogEntrySourceLocation} sourceLocation Optional. Source code location information associated with the log entry,
if any.
...
`LogSeverity.DEFAULT`.
* @property {logging(v2beta1).MonitoredResource} resource Required. The monitored resource associated with this log entry.
...
log entry.
* @property {logging(v2beta1).LogEntryOperation} operation Optional. Information about an operation associated with the log entry, if
applicable.
*/
/**
 * @typedef LogLine
...
See LogEntry.
* @property {logging(v2beta1).LogEntry[]} entries Required. The log entries to write. Values supplied for the fields
...
* @property {logging(v2beta1).MonitoredResource} resource Optional. A default monitored resource object that is assigned to all log
...
* @property {logging(v2beta1).LabelDescriptor[]} labels Required. A set of labels used to describe instances of this monitored
...
value is -1.
* @property {logging(v2beta1).SourceReference[]} sourceReference Source code for the application that handled this request. There can be
